...
# ==================== NAVIGATION TABS ====================
tab_overview, tab_matrix, tab_insights, tab_explorer, tab_ai, tab_mvp, tab_deliverables = st.tabs([
    "📊 Executive Overview",
    "🎯 Opportunity Matrix",
    "🧠 Strategic Insights",
...
# -------------------------------------------------------------------------------------------------
# TAB 7: NEXTLEAP PM DELIVERABLES
# -------------------------------------------------------------------------------------------------
with tab_deliverables:
    st.markdown("### 📄 NextLeap Capstone PM Deliverables (Parts 1 to 7)")
    st.caption("Consolidated documentation generated by the VoC Discovery Engine.")

    section_choice = st.selectbox(
        "Navigate Document Sections:",
        [
            "Full Document (Parts 1 - 7)",
            "Part 1: 10-Question Discovery Audit",
            "Part 2: 30-Day Wishlist Funnel Metric Decomposition Tree",
            "Part 3: 5 Qualitative User Personas & Interview Scripts",
            "Part 4: Root Cause PM Problem Statement",
            "Part 5: MVP Product Specification (StyleStudio)",
            "Part 6: L1/L2 Metrics & Guardrail Framework",
            "Part 7: Failure Modes & Risk Mitigations"
        ]
    )

    if section_choice == "Full Document (Parts 1 - 7)":
        st.markdown(deliverables_md)
    else:
        # Filter section
        st.markdown(f"Displaying **{section_choice}**:")
        st.markdown(deliverables_md)
